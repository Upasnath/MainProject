    ...
    if($_POST){
        ...
        if ($password==$cpassword){
            ...
            $sqlmain= "select users.pid from users inner join webuser on users.pemail=webuser.email where webuser.email=?;";
            ...
            if($id2!=$id){
                ...
                $sql1="update users set pemail='$email',pname='$name',ppassword='$password',pnic='$nic',ptel='$tele',paddress='$address' where pid=$id ;";
                $database->query($sql1);
                echo $sql1;
