...
// }
    ...
    $sender   = $_GET['send'];
    $sql = "SELECT *FROM tbl_message LEFT JOIN users ON users.pemail = tbl_message.outgoing_msg_id 
    ...
    <div class="item-group-other d-flex">
        ...
        <div class="text-message-other">
                  ...
                  <div class="dropdown-options">
                    ...
                    <!-- <a href="#">react meg</a><br><br> -->
                  </div>
                
            <!-- <div class="drp">
                <button id="drp-btn" ><?php echo $msg['text_message']; ?></button>  
                <div class="dropdown-options">
                    <a href="">Add Product</a><br><br>
                    <a href="">View Products</a><br><br>
                    <a href="">Edit Products</a><br><br>
                    <a href="">View Lands</a><br><br>
                    <a href="">View Updates</a><br><br>
                </div>
            </div> -->
            <!-- <a href="#" id="txt-msg"><?php echo $msg['text_message']; ?></a> -->
        </div>
